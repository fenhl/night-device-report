        ...
        #[cfg(windows)] {
            ...
            Ok(Self {
                ...
                scoop_updates: {
                    ...
                    match &*stdout {
                        b"Scoop is up to date.\nEverything is ok!\n" => Vec::default(),
                        b"WARN  Scoop bucket(s) out of date. Run 'scoop update' to get the latest changes.\n" => {
                            // updated during report, ignore and handle during next report
                            Vec::default()
                        }
                        _ => (0..stdout.len())
